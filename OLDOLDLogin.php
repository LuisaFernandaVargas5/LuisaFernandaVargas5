        ...
        <div style="width: 50%; margin: auto; background: rgba(255, 255, 255, 0.85); 
            ...
            <form method="POST" action="#">                   
                <table align="center" cellpadding="10">
                    ...
                    <tr>
                        <td><a href="Recuperacion.php"><h6>¿Olvido su contraseña?</h6></a></td>
                    </tr>
                </table>
            </form>
        </div>
...
if (isset($_POST['Ingresar'])) {
    ...
    $clave = $_POST['clave'];
    $db = new Database();
    $query = connectar()->prepare('SELECT * FROM usuario WHERE correo_usuario = :email AND contraseña_usuario = :clave');
