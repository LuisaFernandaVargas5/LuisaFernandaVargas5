...
if (isset($_POST['Registrarse'])) {
    if ($_POST['contraseña1'] == $_POST['contraseña2']) {
       ...
       $insertar = "INSERT INTO usuario (nombre_usuario,apellido_usuario,user_usuario, contraseña_usuario, correo, Id_Rol) VALUES ('$nombre','$apellido','$usuario','$contraseña','$correo','$rol')";
